...
export default function Section1() {
  ...
  return (
    ...
    >
      ...
      <Link
        href="/signpage"
        className="h-11/12 w-3/12 border-l border-l-white border-r border-r-white hover:border-r-gray-300 hover:border-l-gray-300 transition-all duration-500 flex flex-col items-center justify-around group"
      >
