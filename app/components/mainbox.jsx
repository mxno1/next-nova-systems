...
export default function Main() {
  ...
  return (
    < > 
      <div data-aos="fade-up" className="w-full sm:h-[30vh] md:h-[50vh] lg:h-[70vh]  flex items-center justify-around mt-28 border-b border-t border-gray-200 bg-zinc-50 ">
